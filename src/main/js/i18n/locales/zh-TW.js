...
const zhTW = {
    ...
    feedback: {
        ...
        body: '回饋內容',
        bodyHelper: '{{count}} / {{max}} 字（至少 10 字）',
        submit: '送出',
        submitting: '送出中…',
        submitFailed: '送出回饋失敗',
        sent: '已收到您的回饋，謝謝！',
        // 刻意不寫「我們會盡快回覆您」——那會暗示送出者可被追溯，與匿名的前提矛盾
        sentHint: '由於回饋是匿名的，我們無法個別回覆，但每一則都會被看到。',
        anonymityNotice: '這則回饋是匿名的。',
        loginRequired: '請先登入才能送出回饋。',
        loginRequiredWhy: '要求登入只是為了防止灌水。',
        admin: {
            title: '回饋管理',
            description: '檢視使用者送出的匿名意見回饋',
            empty: '這個狀態下沒有回饋。',
            allStatuses: '全部',
            fetchFailed: '取得回饋清單失敗',
            updated: '回饋已更新',
            updateFailed: '更新回饋失敗',
            deleted: '回饋已刪除',
            deleteFailed: '刪除回饋失敗',
            deleteTitle: '刪除回饋',
            confirmDelete: '確定要刪除這則回饋嗎？此操作無法復原。',
            markRead: '標記為已讀',
            markResolved: '標記為已處理',
            editNote: '管理員備註',
    ...
    errors: {
        ...
        COURSE_NOT_IN_CATALOG: '找不到這門課程，請從搜尋結果中選擇',
        REVIEW_LIMIT_EXCEEDED: '您的評價數量已達上限',
        FEEDBACK_BODY_REQUIRED: '回饋內容為必填，請填寫 10-2000 字',
        FEEDBACK_CATEGORY_INVALID: '回饋分類無效',
        FEEDBACK_STATUS_INVALID: '回饋狀態無效',
        FEEDBACK_NOT_FOUND: '找不到這筆回饋',
        FETCH_FEEDBACK_FAILED: '取得回饋清單失敗',
        CREATE_FEEDBACK_FAILED: '送出回饋失敗',
        UPDATE_FEEDBACK_FAILED: '更新回饋失敗',
        DELETE_FEEDBACK_FAILED: '刪除回饋失敗',
        ...
        // 字數一律由後端的 params 插值帶入（見 config/reviewContent.js），
        // 不要寫死——改門檻時漏改這裡的話，錯誤訊息會跟實際規則對不上
        COURSE_CONTENT_LENGTH: '課程內容為必填，請填寫 {{min}}-{{max}} 字',
        TEACHING_METHOD_LENGTH: '教學方式為必填，請填寫 {{min}}-{{max}} 字',
        ASSIGNMENT_EXAM_FORMAT_LENGTH: '作業與考試形式為必填，請填寫 {{min}}-{{max}} 字',
        GRADING_BREAKDOWN_LENGTH: '評分佔比為必填，請填寫 {{min}}-{{max}} 字',
        COMMENT_LENGTH: '心得為必填，請填寫 {{min}}-{{max}} 字',
