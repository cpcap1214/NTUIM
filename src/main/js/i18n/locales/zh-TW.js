...
const zhTW = {
    ...
    courseReview: {
        ...
        summary: '共 {{count}} 則評價 · 涵蓋 {{courseCount}} 門課程',
        ...
        searchPlaceholder: {
            courses: '搜尋課程代碼、名稱或教授…',
            feed: '搜尋課程或教授…',
        },

        emptyState: {
            noReviewsYet: '目前還沒有任何課程評價',
            noCoursesYet: '目前還沒有任何課程評價',
            noMatchingCourses: '沒有找到符合條件的課程',
    ...
    errors: {
        ...
        QUALITY_RANGE: '課程品質須為1-5',
        DIFFICULTY_RANGE: '難易度須為1-5',
        SWEETNESS_RANGE: '給分高低須為1-5',
        USEFULNESS_RANGE: '實用性須為1-5',
