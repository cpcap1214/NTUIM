...
const en = {
    ...
    feedback: {
        ...
        body: 'Your feedback',
        bodyHelper: '{{count}} / {{max}} characters (at least 10)',
        submit: 'Send',
        submitting: 'Sending…',
        ...
        admin: {
            title: 'Feedback',
            description: 'Read anonymous feedback submitted by users',
            empty: 'No feedback with this status.',
            allStatuses: 'All',
            fetchFailed: 'Could not load feedback',
            updated: 'Feedback updated',
            updateFailed: 'Could not update the feedback',
            deleted: 'Feedback deleted',
            deleteFailed: 'Could not delete the feedback',
    ...
    errors: {
        ...
        FEEDBACK_NOT_FOUND: 'That feedback no longer exists',
        FETCH_FEEDBACK_FAILED: 'Could not load feedback',
        CREATE_FEEDBACK_FAILED: 'Could not send your feedback',
        UPDATE_FEEDBACK_FAILED: 'Could not update the feedback',
        DELETE_FEEDBACK_FAILED: 'Could not delete the feedback',
