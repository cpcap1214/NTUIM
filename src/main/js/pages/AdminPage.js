...
const AdminPage = () => {
    ...
    const uploadExam = async () => {
        ...
        try {
            ...
            setUploadMessage({
                type: 'error',
                text: error.message || t('admin.upload.failedRetry'),
            });
        } finally {
            setUploading(false);
                                                                ...
                                                                <IconButton
                                                                    ...
                                                                    title={
                                                                        managedUser.id === user?.id
                                                                            ? t(
                                                                                  'admin.preview.selfHint',
                                                                              )
                                                                            : t(
                                                                                  'admin.preview.asUser',
                                                                                  {
                                    ...
                                    <Stack spacing={2.5}>
                                        ...
                                        >
                                            <Chip
                                                ...
                                                color={
                                                    activeUser.hasPaidFee ? 'success' : 'default'
                                                }
                                                variant={
                                                    activeUser.hasPaidFee ? 'filled' : 'outlined'
                                                }
                                            />
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    value={examForm.year}
                                    onChange={(e) =>
                                        handleExamChange('year', parseInt(e.target.value))
                                    }
                            ...
                            <Grid item xs={12} sm={4}>
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        onChange={(e) =>
                                            handleExamChange('semester', e.target.value)
                                        }
                                    >
                            ...
                            <Grid item xs={12} sm={4}>
                                <FormControl fullWidth>
                                    ...
                                    <Select
                                        ...
                                        onChange={(e) =>
                                            handleExamChange('examType', e.target.value)
                                        }
                                    >
                            ...
                            <Grid item xs={12} sm={4}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        handleExamChange('examAttempt', parseInt(e.target.value))
                                    }
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                <Box sx={{ border: '1px dashed #ccc', p: 2, textAlign: 'center' }}>
                                    <input
                                        ...
                                        type="file"
                                        onChange={(e) =>
                                            handleFileSelect(e.target.files[0], 'question')
                                        }
                                    />
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                <Box sx={{ border: '1px dashed #ccc', p: 2, textAlign: 'center' }}>
                                    <input
                                        ...
                                        type="file"
                                        onChange={(e) =>
                                            handleFileSelect(e.target.files[0], 'answer')
                                        }
                                    />
                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        handleCheatSheetChange('courseCode', e.target.value)
                                    }
                                    error={!!uploadErrors.courseCode}
                                    helperText={uploadErrors.courseCode}
                                />
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        handleCheatSheetChange('courseName', e.target.value)
                                    }
                                    error={!!uploadErrors.courseName}
                                    helperText={uploadErrors.courseName}
                                />
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        handleCheatSheetChange('title', e.target.value)
                                    }
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        handleCheatSheetChange('description', e.target.value)
                                    }
                            ...
                            <Grid item xs={12}>
                                <Box sx={{ mb: 2 }}>
                                    <TextField
                                        ...
                                        onChange={(e) =>
                                            handleCheatSheetChange('currentTag', e.target.value)
                                        }
                                        onKeyPress={(e) => {
                                            if (e.key === 'Enter') {
                                                e.preventDefault();
              ...
              技術上仍可能用時間戳去對。把界線寫清楚，比假裝風險不存在誠實。 */}
                        ...
                        >
                            <ToggleButton value="new">
                                {t('feedback.admin.status.new')}
                            </ToggleButton>
                            <ToggleButton value="read">
                                {t('feedback.admin.status.read')}
                            </ToggleButton>
                                        ...
                                        <Stack direction="row" spacing={1} flexWrap="wrap">
                                            {item.status !== 'read' && (
                                                <Button
                                                    size="small"
                                                    onClick={() =>
                                                        handleUpdateFeedbackStatus(item, 'read')
                                                    }
                                                >
